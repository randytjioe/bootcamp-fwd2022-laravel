...
<main class = "min-h-screen">
      ...
      <section class="relative mt-12">
        ...
        >
          <img
            src="{{ ('/assets/frontsite/images/hero-image.png') }}"
          ...
          <div class="grid gap-12 mt-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-10">
            <a href="{{ route('appointment.index') }}" class="group">
              <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                <img src="{{ asset('/assets/frontsite/images/doctor-1.png') }}" class="object-cover object-center w-full h-full bg-center bg-no-repeat" alt="Doctor 1">
              ...
              <div class="flex items-center justify-between mt-5">
                ...
                <div class="flex items-center space-x-2">
                  <img src="{{ ('/assets/frontsite/images/star.svg') }}" alt="Star">
            ...
            <a href="{{ route('appointment.index') }}" class="group">
              <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                <img src="{{ asset('/assets/frontsite/images/doctor-2.png') }}" class="object-cover object-center w-full h-full bg-center bg-no-repeat" alt="Doctor 1">
                <div class="opacity-0 group-hover:opacity-100 transition-all ease-in absolute inset-0 bg-[#0D63F3] bg-opacity-70 flex justify-center items-center">
                  <span class="text-[#0D63F3] font-medium bg-white rounded-full px-8 py-3">Book Now</span>
                </div>
              </div>
            ...
            <a href="{{ route('appointment.index') }}" class="group">
              <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                <img src="{{ asset('/assets/frontsite/images/doctor-3.png') }}" class="object-cover object-center w-full h-full bg-center bg-no-repeat" alt="Doctor 1">
                <div class="opacity-0 group-hover:opacity-100 transition-all ease-in absolute inset-0 bg-[#0D63F3] bg-opacity-70 flex justify-center items-center">
                  <span class="text-[#0D63F3] font-medium bg-white rounded-full px-8 py-3">Book Now</span>
                </div>
              </div>
            ...
            <a href="{{ route('appointment.index') }}" class="group">
              <div class="relative z-10 w-full h-[350px] rounded-2xl overflow-hidden">
                <img src="{{ asset('/assets/frontsite/images/doctor-4.png') }}" class="object-cover object-center w-full h-full bg-center bg-no-repeat" alt="Doctor 1">
                <div class="opacity-0 group-hover:opacity-100 transition-all ease-in absolute inset-0 bg-[#0D63F3] bg-opacity-70 flex justify-center items-center">
                  <span class="text-[#0D63F3] font-medium bg-white rounded-full px-8 py-3">Book Now</span>
                </div>
              </div>
