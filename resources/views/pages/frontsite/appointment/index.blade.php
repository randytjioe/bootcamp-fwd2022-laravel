...
@section('content')
    ...
    <div class="min-h-screen">
      <div
        class="items-center px-4 py-20 pt-6 mx-auto lg:max-w-7xl lg:flex lg:px-14 lg:py-24 gap-x-24"
      >
        <!-- Detail Doctor  -->
        <div
        ...
        >
          <img
            ...
            class="inline-block object-cover object-top w-32 h-32 bg-center rounded-full"
            alt="doctor-1"
          />
